...
### View
A panel in Cursor's sidebar. VibeFlow ships five: **Agent Fleet**, **Work Items**, **Project Items**, **Documents** (all in the left activity bar's VibeFlow container), plus **Activity Feed** (in the right-side **VibeFlow Monitor** panel).
